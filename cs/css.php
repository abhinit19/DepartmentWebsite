                           ...
                           <div class=" bottom-border pb-3" >
                            <a href=''><h5 style="color:white"><i class="fas fa-user fa-fw fa-lg mr-3"></i><?php echo $_SESSION['username'] ?></h5></a>
                               ...
                               <ul class="navbar-na flex-column mt-4">
                                 <li class="nav-item"><a class="nav-link text-dark p-3 mb-2  current" href=''><i class="fas fa-database fa-lg mr-3"></i>CSS Test</a></li>               
                              </ul>
                           </div>
                       <!--end of sidebar-->
                       <!--topnav-->
...
if ($answer9 == "C"){$score++;}
if ($answer10 == "B"){$score++;}
$sql=$conn->query("insert into score(username,test_name,mark) values('$_SESSION[username]','css','$score')");
if($sql==true)
{
